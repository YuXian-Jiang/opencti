const i18n = {
  messages: {
    ...
    'zh-tw': {
      ...
      'Do you want to delete this vulnerability?': '是否要刪除此脆弱性？',
      ...
      'auto:': '自動:',
      'Import data': '導入數據',
      'Import successfully asked': '請求導入成功',
      'Import type': '導入類型',
      'STIX2 bundle': 'STIX2捆綁包',
      'File to import': '要導入的文件',
      'Associated file': '關聯的文件',
      'Select your file': '選擇你的文件',
      selected: '已選',
      'selected element(s)': '已選的元素',
      'The importation of the file has been started': '已開始導入文件',
      Add: '添加',
      'Turn to user': '轉向用戶',
      ...
      Takedown_types: '刪除類型',
      Information_types: '信息類型',
      'Export to image': '導出成圖像',
      'Export to PDF': '導出成PDF',
      'Export to CSV': '導出成CSV',
      Periodicity: '週期性',
      'Knowledge update (except indicators & observables)':
        '知識更新(攻擊指標和可觀測數據除外)',
      ...
      'Matrix view': '矩陣視圖',
      'Open export panel': '打開導出面板',
      'Export is disabled because too many entities are targeted (maximum number of entities is: ':
        '匯出被禁用，因為目標實體太多（最大實體數為：',
      'Exports panel': '導出面板',
      'Exports list': '導出列表',
      'Export as image': '導出成圖像',
      'Export as PDF': '導出成PDF',
      'Merge entities': '歸併實體',
      ...
      'Enabled import connectors': '已啓用的導入連接器',
      ...
      'Postal code': '郵遞區號',
      Modified: '修改的',
      'No import connectors on this platform': '此平台沒有導入連接器',
      ...
      Connectors: '連接器',
      Connector: '連接器',
      'Launch an import': '啓動導入',
      Data: '數據',
      Settings: '設置',
      'Entity settings': '實體設置',
      'Dashboard settings': '儀表盤設置',
      About: '關於',
      General: '通用',
      Versions: '版本',
      'Event types': '事件類型',
      ...
      'No connector available for the selected entities.':
        '沒有可用於選定實體的連接器。',
      Enrich: '豐富',
      'Custom dashboards': '自定義儀表盤',
      'Custom dashboard': '自定義儀表盤',
      ...
      'Export format': '導出格式',
      'Export successfully started': '導出已成功啓動',
      'Export type': '導出類型',
      'Export to image (png)': '導出到圖像(png)',
      'Export to document (pdf)': '導出到文檔(pdf)',
      'Generate an export': '生成導出',
      'No export connector available to generate an export':
        '沒有可以用於生成導出的導出連接器',
      'Simple export (just the entity)': '簡單導出(僅實體)',
      'Full export (entity and first neighbours)': '完全導出(實體和第一個鄰居)',
      'Uploaded files': '已上傳的文件',
      'Delete this workbench': '刪除此工作區',
      'Validate and send for import': '驗證並發送以進行導入',
      ...
      'File successfully uploaded and associated external reference successfully created':
        '已成功上載檔並成功創建關聯的外部引用',
      'Launch an import of this file': '啓動此文件的導入',
      Launch: '啓動',
      'Rule rescan': '規則重新掃描',
      ...
      INTERNAL_IMPORT_FILE: '導入文件',
      INTERNAL_EXPORT_FILE: '導出文件',
      ...
      'Data import and analyst workbenches': '數據導入與分析工作室 (Data import and analyst workbenches)',
