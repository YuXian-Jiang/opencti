const i18n = {
  messages: {
    ...
    'zh-tw': {
      ...
      // Errors
      Error: '錯誤',
      'Bad login or password': '用戶名或密碼錯誤',
      'An unknown error has occurred!  Please try again later.':
        '發生未知錯誤，請稍後再試。',
      'You must be logged in to do this.': '您必須登入才能執行此操作。',
      'You are not allowed to do this.': '您這樣操作不被允許。',
      'You have successfully logged out.': '您已成功登出。',
      'You do not have any access to the knowledge of this OpenCTI instance.':
        '您無權訪問此OpenCTI實例的知識數據。',
      'Write something awesome...': '寫一些很棒的東西...',
      // Dependencies
      Elasticsearch: 'Elasticsearch',
      RabbitMQ: 'RabbitMQ',
      Redis: 'Redis',
      ...
      lte: '小於或等於',
      Login: '登入',
      'Two-factor authentication': '雙因素(2FA)身份驗證',
      'Enforce two-factor authentication': '強制執行雙因素(2FA)身份驗證',
      'Use 2FA authentication': '使用雙因素(2FA)身份驗證',
      'You need to validate your two-factor authentication. Please type the code generated in your application.':
        '您需要驗證您的雙因素(2FA)身份驗證。請輸入在您的應用程式中生成的驗證碼。',
      'You need to activate a two-factor authentication. Please type the code generated in your application.':
        '您需要啟動雙因素(2FA)身份驗證。請輸入在您的應用程式中生成的驗證碼。',
      Search: '搜尋',
      Active: '活躍',
      'Last update': '上次更新',
      'Create a file': '創建文件',
      'Infrastructure types': '基礎設施類型',
      Progress: '進展',
      errors: '錯誤',
      State: '狀態',
      'Status templates': '狀態模板',
      'Copied to clipboard': '已復製到剪貼板',
      Infrastructures: '基礎設施',
      'Advanced search': '高級搜尋',
      'Global keyword': '全局關鍵詞',
      'Search for a threat...': '搜尋威脅...',
      'Do you want to delete this status template?': '想要刪除此狀態範本？',
      'Do you want to remove this status?': '您要刪除此狀態嗎？',
      'Create a status template': '創建狀態範本',
      'Update a status template': '更新狀態範本',
      'Do you want to delete this file?': '你想刪除這個文件嗎？',
      'Do you want to remove this job?': '您要刪除此作業嗎？',
      'Do you want to delete this user?': '是否要刪除此用戶？',
      'Do you want to delete this group?': '是否要刪除此組？',
      'Do you want to delete this threat actor?': '是否要刪除此威脅主體？',
      'Do you want to delete this intrusion set?': '是否要刪除此入侵集合？',
      'Do you want to delete this campaign?': '是否要刪除此攻擊活動？',
      'Do you want to delete this incident?': '是否要刪除此安全事件？',
      'Do you want to browse this external link?': '是否要瀏覽此外部鏈接？',
      'Browse the link': '瀏覽鏈接',
      'Do you want to delete this malware?': '是否要刪除此惡意軟體？',
      'Do you want to delete this marking definition?':
        '是否要刪除此標記定義？',
      'Do you want to delete this kill chain phase?':
        '是否要刪除此殺傷鏈階段？',
      'Do you want to delete this report?': '是否要刪除此報告？',
      'Cascade delete': '級聯刪除',
      'In this report, ': '在這份報告中，',
      'element(s) are not linked to any other reports and will be orphan after the deletion.':
        '元素未鏈接到任何其他報告，刪除後將成為孤立元素。',
      'Also delete these elements': '同時刪除這些元素',
      'Do you want to kill this session?': '是否要終止此會話？',
      'Do you want to kill all the sessions of this user?':
        '是否要終止此用戶的所有會話？',
      'Do you want to delete this external reference?':
        '是否要刪除此外部引用？',
      'Do you want to delete this region?': '是否要刪除此區域？',
      'Do you want to delete this country?': '是否要刪除此國家/地區？',
      'Do you want to delete this area?': '是否要刪除此區域?',
      'Do you want to delete this city?': '是否要刪除此城市？',
      'Do you want to delete this sector?': '是否要刪除此部門？',
      'Do you want to delete this system?': '是否要刪除此係統？',
      'Do you want to delete this organization?': '是否要刪除此組織？',
      'Do you want to delete this individual?': '是否要刪除此個體？',
      'Do you want to delete this relation?': '是否要刪除此關係？',
      'Do you want to delete this sighting?': '是否要刪除此目擊？',
      'Do you want to delete this workspace?': '是否要刪除此工作區？',
      'Do you want to delete this widget?': '你想刪除這個小部件嗎？',
      'Do you want to delete this attack pattern?': '是否要刪除此攻擊模式？',
      'Do you want to delete this course of action?': '是否要刪除此應對措施？',
      'Do you want to delete this data component?': '是否要刪除此資料元件？',
      'Do you want to delete this data source?': '你想刪除這個數據源嗎?',
      'Do you want to delete this tool?': '是否要刪除此工具？',
      'Do you want to delete this vulnerability?': '是否要刪除此漏洞？',
      'Do you want to delete this indicator?': '是否要刪除此攻擊指標？',
      'Do you want to delete this observable?': '是否要刪除此可觀測數據？',
      'Do you want to delete this observed data?': '是否要刪除此觀測數據？',
      'Do you want to remove the entity from this report?':
        '是否要從此報告中移除該實體？',
      'Do you want to delete this attribute?': '是否要刪除此屬性？',
      'Do you want to remove this external reference?':
        '是否要移除此外部引用？',
      'Do you want to remove this note?': '是否要移除此註釋？',
      'Do you want to remove this report?': '是否要移除此報告？',
      'Do you want to remove these elements from this report?':
        '是否要從此報告中移除這些元素？',
      'Do you want to remove these elements from this investigation?':
        '是否要從此調查中移除這些元素？',
      'Do you want to remove this opinion?': '是否要移除此意見？',
      'Do you want to remove the observable from this indicator?':
        '是否要移除此攻擊指標中移除該可觀測數據？',
      'Do you want to remove the entity from this container?':
        '是否要從此容器中移除該實體？',
      'Do you want to remove the indicator from this observable?':
        '你想從這個技術元素中刪除指標嗎？',
      'Do you want to delete this role?': '是否要刪除此角色？',
      'Do you want to delete this label?': '是否要刪除此標籤？',
      'Do you want to delete this note?': '是否要刪除此註釋？',
      'Do you want to delete these entities?': '是否要刪除這些實體？',
      'Do you want to delete this live stream?': '是否要刪除此實時流？',
      'Do you want to delete this feed?': '您要刪除此提要嗎？',
      'Do you want to delete this synchronizer?': '是否要刪除此同步器？',
      'Do you want to start this synchronizer?': '是否要啓動此同步器？',
      'Do you want to stop this synchronizer?': '是否要刪除此同步器？',
      'Do you want to create a STIX Indicator from this observable?':
        '是否要從此可觀測數據創建一個STIX攻擊指標？',
      'Do you want to enable this rule?': '是否要啓用該規則？',
      'Do you want to disable this rule?': '是否要禁用該規則？',
      'Do you want to delete this workbench?': '是否要丟棄此捆綁包?',
      'Applying this rule on the existing data': '對現有數據應用此規則',
      'This rule has been applied on the existing data':
        '該規則已應用於現有數據',
      'Cleaning up this rule on the existing data':
        '正在清除現有數據上的此規則',
      'Rule has been cleaned up on the existing data': '已清除現有數據上的規則',
      ...
      'The rule has been disabled, clean-up launched...':
        '該規則已禁用，清理已啓動',
      'Rules engine': '規則引擎',
      'Launch rescan': '啓動重新掃描',
      'Enabled the ': '啓用該',
      'Never enabled': '從未啓用',
      Information: '信息',
      'Last reports': '最後報告',
      'Related reports': '相關報道',
      Enable: '啓用',
      Disable: '禁用',
      Rescan: '重新掃描',
      'Last notes': '最後註釋',
      'Latest reports written by this entity': '該實體編寫的最新報告',
      'Latest reports about this entity': '關於該實體的最新報告',
      'Last reports about the entity': '關於該實體的最後報告',
      'Last observables': '最後的可觀測數據',
      'observable(s)': '可觀測數據',
      'Last modified entities': '最後修改的實體',
      'Global parameters': '全局參數',
      'External authentication': '外部認證',
      'Authentication strategies': '認證策略',
      'Groups with this role': '具有此角色的組',
      'Granted by default': '默認授予',
      'Granted by default at user creation': '在用戶創建時默認授予',
      'Automatically authorize this group to new marking definition':
        '自動將此組權限授權給新的標記定義',
      'Unauthorized action, please refresh your browser':
        '未授權的操作，請刷新瀏覽器',
      Capabilities: '能力',
      Title: '標題',
      'Sender email address': '發件人電子郵件地址',
      'Base URL': '基本URL',
      'No value': '沒有價值',
      Theme: '主題',
      Default: '默認',
      Light: '淺色',
      Dark: '暗色',
      'Light (with background)': '淺色(帶背景)',
      'Light (without background)': '淺色(無背景)',
      'Dark (with background)': '暗色(帶背景)',
      'Dark (without background)': '暗色(無背景)',
      Language: '語言',
      'This configuration is not available for this entity type':
        '此配置不適用於此實體類型',
      'Hidden entity types': '隱藏的實體類型',
      'Hidden in roles': '隱藏在角色中',
      'Hidden in interface': '隱藏在界面中',
      'This configuration hide a specific entity type across the entire platform.':
        '此配置隱藏了整個平台的特定實體類型。',
      'Enforce reference on entity type': '對實體類型強制引用',
      'Enforce reference': '強制引用',
      'This configuration enables the requirement of a reference message on an entity update.':
        '此配置啓用了對實體更新的參考消息的要求。',
      'This configuration enables an entity to automatically construct an external reference from the uploaded file.':
        '此配置使實體能夠從上傳的文件自動構建外部引用。',
      'Mandatory attributes': '必須屬性',
      'Default mandatory attributes': '默認強制屬性',
      'Additional mandatory attributes': '額外的強制屬性',
      'Make this stream public and available to anyone':
        '將此流公開並提供給任何人',
      'Public stream': '公共流',
      Automatic: '自動',
      Manual: '手動',
      'Automatic trigger': '自動觸發',
      'Only contextual': '僅上下文',
      'Not aplicable': '不適用',
      Roles: '角色',
      Subsectors: '子部門',
      'Sub attack patterns': '子攻擊模式',
      'Parent attack patterns': '父攻擊模式',
      'Parent sectors': '父部門',
      Subregions: '子區域',
      'Parent regions': '父區域',
      'Not applicable': '不適合',
      ...
      Yes: '是',
      No: '否',
      'Just in the report': '就在報告中',
      'In all the database': '在所有數據庫中',
      Create: '創建',
      Update: '更新',
      Replace: '替換',
      ...
      Cancel: '取消',
      Import: '匯入',
      'No files in this category.': '此類別中沒有文件。',
      'Text files': '文本文件',
      'HTML files': 'HTML 文件',
      'PDF files': 'PDF 文件',
      'Markdown files': '降價文件',
      ...
      'auto:': '自動:',
      'Import data': '匯入數據',
      'Import successfully asked': '請求匯入成功',
      'Import type': '匯入類型',
      'STIX2 bundle': 'STIX2捆綁包',
      'File to import': '要匯入的文件',
      'Associated file': '關聯的文件',
      'Select your file': '選擇你的文件',
      selected: '已選',
      'selected element(s)': '已選的元素',
      'The importation of the file has been started': '已開始匯入文件',
      Add: '添加',
      'Turn to user': '轉向用戶',
      'This individual is now a user': '此個體現在是用戶',
      'This relation is inferred': '該關係是推理出來的',
      'This field is required': '此字段為必填項',
      'This field must only contain alphanumeric chars, dashes and space':
        '此字段只能包含字母、數字、字符、下劃線和空格',
      'The value is too short': '該值太短',
      'The value is too long': '該值太長',
      'The value must be a number': '該值必須是一個數字',
      'The value must be an email address': '該值必須是一個郵件地址',
      'The value must be an URL': '該值必須是一個URL',
      'Starting synchronization (empty = from start)':
        '開始同步(空的 = 從一開始)',
      'User responsible for data creation (empty = System)':
        '負責數據創建的用戶（空 = System）',
      'The value must be a date (yyyy-MM-dd)': '該值必須是一個日期(yyyy-MM-dd)',
      'The value must be a datetime (yyyy-MM-dd hh:mm (a|p)m)':
        '該值必須是一個日期(yyyy-MM-dd hh:mm a)',
      'The value must be a datetime with seconds (yyyy-MM-dd hh:mm:ss (a|p)m)':
        '該值必須是一個日期(yyyy-MM-dd hh:mm:ss a)',
      'The values do not match': '該值不匹配',
      'No available options': '沒有可用的選項',
      'No description of this usage': '沒有關於此用法的描述',
      'No description of this targeting': '沒有關於此針對的描述',
      'No history about this relationship.': '沒有關於此關係的歷史',
      'Create a workspace': '創建工作區',
      'Update a workspace': '更新工作區',
      'Create an event': '創建活動',
      ...
      'Create a group': '創建組',
      'Update a group': '更新組',
      'Create an entity': '創建實體',
      'Update an entity': '更新實體',
      'Create an artifact': '創建工件',
      'Update an artifact': '更新工件',
      'Create an infrastructure': '創建基礎設施',
      'Update an infrastructure': '更新基礎設施',
      'Create a threat actor': '創建威脅主體',
      'Update a threat actor': '更新威脅主體',
      'Create an intrusion set': '創建入侵集合',
      'Update an intrusion set': '更新入侵集合',
      'Create a campaign': '創建攻擊活動',
      'Update a campaign': '更新攻擊活動',
      'Create an incident': '創建安全事件',
      'Update an incident': '更新安全事件',
      'Create a malware': '創建惡意軟體',
      'Update a malware': '更新惡意軟體',
      'Create a channel': '創建頻道',
      'Update a channel': '更新頻道',
      'Create a narrative': '創建敍述',
      'Update a narrative': '更新敍述',
      'Create an observed data': '創建可觀測數據',
      'Update an observed data': '更新可觀測數據',
      'Create a subscription': '創建一個訂閲',
      'Update a subscription': '更新一個訂閲',
      'Create a synchronizer': '創建一個同步器',
      'Update a synchronizer': '更新一個同步器',
      'Create a case incident': '創建個案事件',
      'Update a case incident': '更新案例事件',
      'Create a feedback': '創建回饋',
      'Update a feedback': '更新一個回饋',
      'Submit a feedback': '提交回饋',
      'Do you want to delete this case incident ?': '是否要刪除此案例事件？',
      'Do you want to delete this feedback ?': '要刪除此回饋嗎？',
      'Do you want to delete this request for information case ?': '是否要刪除此信息案例請求？',
      'Do you want to delete this request for takedown case ?': '您要刪除此移除案例請求嗎？',
      'Create a request for information': '創建信息請求',
      'Update a request for information': '更新信息請求',
      'Create a request for takedown': '創建移除請求',
      'Update a request for takedown': '更新移除請求',
      'Request for Information date': '索取資料日期',
      'Request for Takedown date': '請求刪除日期',
      takedown_types: '刪除類型',
      information_types: '信息類型',
      Takedown_types: '刪除類型',
      Information_types: '信息類型',
      'Export to image': '匯出成圖像',
      'Export to PDF': '匯出成PDF',
      'Export to CSV': '匯出成CSV',
      Periodicity: '週期性',
      'Knowledge update (except indicators & observables)':
        '知識更新(攻擊指標和可觀測數據除外)',
      'Containers (reports, notes & opinions)': '容器(報告、註釋和建議)',
      Containers: '容器',
      'Technical elements (indicators & observables)':
        '技術元素(攻擊指標和可觀測數據)',
      'As it happens': '當其發生時',
      ...
      'PDF viewer': 'PDF查看器',
      'Last run:': '上次運行:',
      'Remote OpenCTI configuration': '遠程 OpenCTI 配置',
      'Remote OpenCTI URL': '遠程OpenCTI URL',
      'Remote OpenCTI token': '遠程OpenCTI token',
      'Remote OpenCTI stream ID': '遠程OpenCTI流ID',
      'Optional, you may want to subscribe to specific entities.':
        '可選，你可能希望訂閲特定實體。',
      'Every 1 hour': '每1小時',
      ...
      'Every month': '每個月',
      'New alias': '新別名',
      'Aliases separated by commas': '用逗號分隔的別名',
      Alias: '別名',
      'Entity aliases': '實體別名',
      'Create a marking definition': '創建標記定義',
      'Update a marking definition': '更新標記定義',
      'Marking definitions': '標記定義',
      'Max marking definition level': '最大標記定義級別',
      'Create a label': '創建標籤',
      'Update a label': '更新標籤',
      'Create a kill chain phase': '創建殺傷鏈階段',
      'Update a kill chain phase': '更新殺傷鏈階段',
      'Create a report': '創建報告',
      'Update a report': '更新報告',
      'Create a region': '創建區域',
      'Update a region': '更新區域',
      'Create a country': '創建國家/地區',
      'Update a country': '更新國家/地區',
      'Create an area': '創建區域',
      'Update an area': '更新區域',
      'Create a sector': '創建部門',
      'Update a sector': '更新部門',
      'Create a system': '創建系統',
      'Update a system': '更新系統',
      'Create a city': '創建城市',
      'Update a city': '更新城市',
      'Create a position': '創建職位',
      'Update a position': '更新職位',
      'Create an organization': '創建組織',
      'Update an organization': '更新組織',
      'Create a individual': '創建個體',
      'Update a individual': '更新個體',
      'Create an external reference': '創建外部引用',
      'Update an external reference': '更新外部引用',
      'Create an attack pattern': '創建攻擊模式',
      'Update an attack pattern': '更新攻擊模式',
      'Create a course of action': '創建應對措施',
      'Update a course of action': '更新應對措施',
      'Create a data component': '創建資料元件',
      'Update a data component': '更新數據元件',
      'Create a data source': '創建數據源',
      'Update a data source': '更新數據源',
      'Create a tool': '創建攻擊工具',
      'Update a tool': '更新攻擊工具',
      'Create a vulnerability': '創建漏洞',
      'Update a vulnerability': '更新漏洞',
      'Create an observable': '創建可觀測數據',
      'Update an observable': '更新可觀測數據',
      'Create an indicator': '創建攻擊指標',
      'Update an indicator': '更新攻擊指標',
      'Create an indicator from this observable': '從該可觀測數據創建攻擊指標',
      'Create a relationship': '創建關係',
      'Create a nested relationship': '創建嵌套關係',
      'Update a relationship': '更新關係',
      'Select a relationship': '更新關係',
      'Create a sighting': '創建目擊',
      'Update a sighting': '更新目標',
      'Create an attribute': '創建屬性',
      'Update an attribute': '更新屬性',
      'Create a role': '創建角色',
      'Update a role': '更新角色',
      'Create a note': '創建註釋',
      'Update a note': '更新註釋',
      'Write a note': '寫註釋',
      'Create a TAXII collection': '創建TAXII集合',
      'Update a TAXII collection': '更新TAXII集合',
      'Create a live stream': '創建實時流',
      'Let the field empty to grant all users':
        '將該字段設置為空，以授權給所有用戶',
      'Update a live stream': '更新實時流',
      'Create a feed': '創建提要',
      'Update a feed': '更新提要',
      'Add external references': '添加外部引用',
      'Add notes': '添加註釋',
      'added a note': '添加了註釋',
      'Add courses of action': '添加應對措施',
      'Add data components': '添加數據組件',
      'Add data source': '添加數據源',
      'Add subsectors': '添加子部門',
      'Add sub attack patterns': '添加子攻擊模式',
      'Add attack patterns': '添加攻擊模式',
      'Add entities': '添加實體',
      'Add observables': '添加可觀測數據',
      'Add observable': '添加可觀測數據',
      'The password has been updated': '密碼已更新',
      'The alias has been added': '別名已添加',
      'Settings have been updated': '設置已更新',
      'Export the entity': '匯出實體',
      ...
      'Lines view': '線條視圖',
      'Graph view': '圖形視圖',
      'Tactics matrix view': '戰術矩陣視圖',
      'Entities view': '實體視圖',
      'Kill chain view': '殺傷鏈視圖',
      'Courses of action view': '應對措施視圖',
      'Correlation view': '關聯視圖',
      'Matrix view': '矩陣視圖',
      'Open export panel': '打開匯出面板',
      'Export is disabled because too many entities are targeted (maximum number of entities is: ':
        '匯出被禁用，因為目標實體太多（最大實體數為：',
      'Exports panel': '匯出面板',
      'Exports list': '匯出列表',
      'Export as image': '匯出成圖像',
      'Export as PDF': '匯出成PDF',
      'Merge entities': '歸併實體',
      'Selected entities': '選定的實體',
      'Merged entity': '歸併的實體',
      'Demo credentials': 'Demo憑證',
      'User will be created with default groups.': '將使用預設組創建使用者。',
      'No connectors are enabled on this platform.': '此平台未啓用任何連接器。',
      'Enabled import connectors': '已啓用的匯入連接器',
      'No enrichment connectors on this platform': '此平台上沒有富化連接器',
      'Enrichment connectors': '富化連接器',
      'Copy disabled: too many selected elements (maximum number of elements for a copy: ':
        '複製已關閉：選取元素過多（複製的最大元素數：',
      Copy: '複製',
      'Elements successfully copied': '已成功複製元素',
      'Registered connectors': '已註冊連接器',
      'The relations attached to selected entities will be copied to the merged entity.':
        '附加到選定實體的關係將複製到歸併的實體中。',
      'Subscriptions & digests': '訂閲和摘要',
      Scope: '範圍',
      'Mini map': '小地圖',
      'Street address': '街道位址',
      'Postal code': '郵遞區號',
      Modified: '修改的',
      'No import connectors on this platform': '此平台沒有匯入連接器',
      'No connectors for this type of entity': '此類型的實體沒有連接器',
      'This connector is active': '此連接器處於活動狀態',
      'This connector is disconnected': '此連接器已斷開連接',
      'Reset the connector state': '重置連接器狀態',
      'Clear this connector': '清除此連接器',
      'The connector state has been reset': '連接器狀態已重置',
      'The connector has been cleared': '連接器已清理',
      'Refresh the knowledge using this connector': '使用此連接器刷新知識',
      'Sectors and organizations': '部門和組織',
      'Regions, countries and cities': '區域、國家/地區和城市',
      'Direct targeting of this sector': '直接針對該部門',
      'Direct targeting of this region': '直接針對該區域',
      'Direct targeting of this country': '直接針對該國家/地區',
      'Groups permissions on data marking is not fully implemented yet.':
        '對數據標記的組權限尚未完全實現。',
      'No potential duplicate entities has been found.': '未找到潛在的重複實體',
      'potential duplicate entity': '潛在重複實體',
      'has been found.': '已發現。',
      'potential duplicate entities': '潛在重複實體',
      'have been found.': '已發現。',
      'Potential duplicate entities': '潛在重複實體',
      // Menu
      Dashboard: '儀錶板',
      ...
      Connectors: '連接器',
      Connector: '連接器',
      'Launch an import': '啓動匯入',
      Data: '數據',
      Settings: '設置',
      'Entity settings': '實體設置',
      'Dashboard settings': '儀錶板設置',
      About: '關於',
      General: '通用',
      Versions: '版本',
      'Event types': '事件類型',
      'Platform title': '平台標題',
      'Platform favicon URL': '平台圖標 URL',
      'Labels & Attributes': '標籤和屬性',
      Observations: '可觀測數據',
      Labels: '標籤',
      Label: '標籤',
      Accesses: '接入',
      ...
      Channel: '渠道',
      Channels: '頻道',
      'Courses of action': '應對措施',
      'Course of action': '應對措施',
      ...
      Indicator: '攻擊指標',
      Indicators: '攻擊指標',
      'Entity enrichment': '實體充實',
      'Selected connectors': '選定的連接器',
      'No connector available for the selected entities.':
        '沒有可用於選定實體的連接器。',
      Enrich: '豐富',
      'Custom dashboards': '自定義儀錶板 (Custom dashboards)',
      'Custom dashboard': '自定義儀錶板',
      ...
      'Entity types': '實體類型',
      'Attack pattern usage': '攻擊模式使用',
      'Vulnerability usage': '漏洞使用',
      'Entity usage': '實體使用',
      'Distribution:': '分佈:',
      Distribution: '分佈:',
      'Reports distribution': '報告分佈',
      'Targeting types': '針對類型',
      'Used TTPs': '使用的TTPs',
      Evolution: '演變',
      'Targeting through time': '按時間針對',
      'TTPs through time': '按照時間TTPs',
      Graph: '圖標',
      'Techniques matrix': '技術矩陣',
      'Targeting knowledge': '針對知識',
      'TTPs knowledge': 'TTPs知識',
      Compare: '對比',
      'Threats targeting': '威脅針對',
      'TTPs of threats': '威脅的TTPs',
      'Number of': '數目',
      Number: '數目',
      Count: '總數',
      'Top 10:': 'Top 10:',
      ...
      Configuration: '配置',
      Victimology: '受害者研究',
      'Victimology (countries)': '受害者學（國家）',
      'Victimology (regions)': '受害者學（地區）)',
      'Victimology (sectors)': '受害者學（部門）',
      'Used tools': '用過的工具',
      'Processing status': '處理狀態',
      'Attack patterns': '攻擊模式',
      'Attack Patterns': '攻擊模式',
      TTPs: 'TTPs',
      'Mitigated attack patterns': '緩解的攻擊模式',
      Techniques: '技術',
      'All reports': '所有報告',
      Tactics: '戰術',
      Countries: '國家/地區',
      ...
      entity_Feedback: '回饋',
      'entity_Case-Incident': '事件',
      'entity_Case-Rfi': '索取資料',
      'entity_Case-Rft': '要求刪除',
      entity_Arsenal: '武器庫',
      entity_Entities: '實體',
      entity_Techniques: '技術',
      entity_Locations: '地點',
      ...
      Running: '開始',
      'Current state': '當前狀態',
      'Enable 3D mode': '啓用3D模式',
      'Disable 3D mode': '禁用3D模式',
      'Enable tree mode': '啓用樹形模式',
      'Disable tree horizontal mode': '禁用水平樹形模式',
      'Disable tree vertical mode': '禁用垂直樹形模式',
      'Enable forces': '啓用強制',
      'Disable forces': '禁用強制',
      'Display time range selector': '顯示時間範圍選擇器',
      'Display notes': '顯示註釋',
      'Unfix the nodes and re-apply forces': '取消固定節點並重新應用強制',
      'Fit graph to canvas': '將圖表適配到畫布',
      'Filter entity types': '過濾實體類型',
      'Filter authors (created by)': '過濾作者(創建者)',
      'Filter marking definitions': '過濾標記定義',
      'Select all nodes': '選擇所有節點',
      'Select by entity type': '按實體類型選擇',
      'Add an entity to this container': '將實體添加到此容器',
      'Edit the selected item': '編輯選中項',
      'Remove selected items': '移除選中項',
      'Remove from this entity': '從該實體中移除',
      'Remove from this object': '從該對象中移除',
      'All observables': '所有可觀測數據',
      ...
      'MAC addresses': 'MAC地址',
      'Email addresses': '郵箱地址',
      'File hashes': '文件哈希',
      'PDB Path': 'PDB路徑',
      'Attack pattern': '攻擊模式',
      'Attributed to this actor': '歸因到此威脅主體',
      'Targeted by this actor': '被此威脅主體針對',
      'Used by this actor': '被此威脅主體使用',
      'Targeting this sector': '針對此部門',
      'Affecting this sector': '影響此部門',
      'Part of this sector': '此部門的一部分',
      'Origins of this intrusion set': '該入侵集合的起源',
      'Attributed to this intrusion set': '歸因到該入侵集合',
      'Used by this intrusion set': '被該入侵集合使用',
      'Targeted by this intrusion set': '被此入侵集合針對',
      'Origins of this campaign': '該攻擊活動的起源',
      'Attributed to this campaign': '歸因到該攻擊活動',
      'Used in this campaign': '被該攻擊活動使用',
      'Targeted in this campaign': '被該攻擊活動針對',
      'Origins of this incident': '該安全事件的起源',
      'Targeted in this incident': '被該安全事件針對',
      'Used in this incident': '被該安全事件使用',
      'Origins of the malware': '該惡意軟體的起源',
      Usage: '用法',
      'Threats using this malware': '威脅使用該惡意軟體',
      Variants: '變種',
      'Variants of this malware': '該惡意軟體的變種',
      'Targeted by this malware': '被該惡意軟體針對',
      'Used by this malware': '被該惡意軟體使用',
      'This malware has been used': '該惡意軟體已經被使用',
      'Using this TTP': '使用該TTP',
      'Targeted by this TTP': '被該TTP針對',
      'Using this tool': '使用該工具',
      'Tool usage': '工具用法',
      'Targeting this vulnerability': '針對該漏洞',
      'Related to this organization': '關聯到該組織',
      'Belonging to this organization': '歸屬於該組織',
      'Attributed to this organization': '歸因到該組織',
      'Attributed to this individual': '歸因到此個體',
      'Targeting this organization': '針對該組織',
      'Locations of this organization': '該組織的位置',
      'This individual is part of': '此個體是其一部分',
      'Localized in this country': '在此國家/地區本地化',
      'Locations of this individual': '此個體的位置',
      'Targeting this individual': '針對此個體',
      'Targeting this country': '針對此國家/地區',
      'Attributed to this country': '歸因到此國家/地區',
      'Related to this country': '關聯到此國家/地區',
      'Localized in this region': '在此區域本地化',
      'Targeting this region': '針對該區域',
      'Attributed to this region': '歸因到該區域',
      'Related to this region': '關聯到該區域',
      Reliability: '可靠性',
      'Contact information': '聯繫信息',
      Inferences: '引用',
      'Action type': '行動類型',
      'Inference rules': '推理規則',
      'Inferred knowledge based on the rule ': '基於規則推理的知識',
      'View the item': '查看項目',
      'CSV file': 'CSV文件',
      'Export data in CSV': '以CSV格式匯出數據',
      'The CSV file has been generated with the parameters of the view and is ready for download.':
        'CSV文件已使用視圖的參數生成，並已準備好下載。',
      'Generated the': '已生成',
      'Never generated': '從未生成',
      'Generation in progress...': '正在生成...',
      'Export format': '匯出格式',
      'Export successfully started': '匯出已成功啓動',
      'Export type': '匯出類型',
      'Export to image (png)': '匯出到圖像(png)',
      'Export to document (pdf)': '匯出到文檔(pdf)',
      'Generate an export': '生成匯出',
      'No export connector available to generate an export':
        '沒有可以用於生成匯出的匯出連接器',
      'Simple export (just the entity)': '簡單匯出(僅實體)',
      'Full export (entity and first neighbours)': '完全匯出(實體和第一個鄰居)',
      'Uploaded files': '已上傳的文件',
      'Delete this workbench': '刪除此工作區',
      'Validate and send for import': '驗證並發送以進行匯入',
      'Validate this workbench': '驗證此工作區',
      'File successfully removed': '已成功移除文件',
      'File and associated external reference successfully removed':
        '已成功刪除檔和關聯的外部引用',
      'File successfully uploaded': '已成功上傳文件',
      'File successfully uploaded and associated external reference successfully created':
        '已成功上載檔並成功創建關聯的外部引用',
      'Launch an import of this file': '啓動此文件的匯入',
      Launch: '啓動',
      'Rule rescan': '規則重新掃描',
      'Rule rescan (engine is disabled)': '規則重新掃描（引擎已禁用）',
      'Rule entity rescan': '規則實體重新掃描',
      'Selected rules': '選定的規則',
      'Element will be rescan with all compatible activated rules':
        '將使用所有相容的啟用規則重新掃描元素',
      'Launch a background task': '啓動後台任務',
      'Take deletions into account': '考慮刪除',
      'Avoid dependencies resolution': '避免依賴解析',
      Initiator: '發起者',
      'Targeted entities': '針對的實體',
      'Background tasks': '後台任務',
      Verify: '驗證',
      'Connection successfully verified': '已成功驗證連接',
      "You're targeting more than 1000 entities with this background task, be sure of what you're doing!":
        '您正在使用此後台任務針對超過1000個實體，請確保您正在執行的操作!',
      Filters: '過濾器',
      'Number of elements': '元素數量',
      'Download this file': '下載此文件',
      'Delete this file': '刪除此文件',
      'No file for the moment': '暫無文件',
      'File information': '文件信息',
      'Copy/paste text content': '複製/粘貼文本內容',
      'Free text import': '自由文本匯入',
      'Bundle details': '捆綁包詳情',
      'Bundle content': '捆綁包內容',
      Dependencies: '依賴',
      Impacted: '影響',
      'JSON content': 'JSON內容',
      'Last modified': '上次修改',
      'Linked entity': '鏈接實體',
      'Number of entities': '實體數量',
      'Number of relationships': '關係數量',
      'Live streams': '實時流',
      'Feeds (CSV)': '供稿 (CSV)',
      'Rolling time': '查詢間隔',
      'Rolling time (in minutes)': '查詢間隔（分鐘）',
      'Include headers in the feed': '在提要中包含標題',
      Separator: '分隔器',
      Column: '欄',
      Columns: '列',
      'Data sharing': '數據共享',
      ...
      Download: '下載',
      'Exported files': '匯出的文件',
      'Inference explanation': '推理解釋',
      Explanation: '解釋',
      More: '更多',
      'Too many objects': '對象過多',
      'List of entities': '實體列表',
      'This report contains too many objects to be displayed as a graph. We are working on a new visualization which will allow large graph to be displayed in the future.':
        '此報告包含的對象過多，無法顯示為圖形。我們正在研究一種新的可視化，這將允許展示更大的圖形。',
      Step: '步驟',
      Field: '字段',
      Continue: '繼續',
      'Field type': '字段類型',
      'Number of errors': '錯誤數量',
      'Last run': '上次運行',
      Values: '值',
      entity: '實體',
      entities: '實體',
      Relation: '關係',
      progress: '進展',
      'Multiple entities selected': '已選擇多個實體',
      Perspective: '看法',
      'Data type': '數據類型',
      // User
      'Sign in': '登入',
      ...
      'Start date': '開始日期',
      'End date': '結束日期',
      'Knowledge entity': '知識實體',
      'Based on': '基於',
      complete: '完成',
      wait: '等待',
      Works: '工作',
      'In progress works': '進行中的工作',
      ...
      'Received time': '接收時間',
      'Processed time': '處理時間',
      'Work start time': '工作開始時間',
      'Task start time': '任務開始時間',
      'Work end time': '工作結束時間',
      'Task end time': '任務結束時間',
      'Operations completed': '已完成的操作',
      'Total number of operations': '操作總數',
      // Properties
      Entity: '實體',
      Widget: '控件',
      Size: '大小',
      ...
      'Is family': '是同一家族',
      'Is family?': '是否是同一家族?',
      'Architecture execution env.': '架構執行環境',
      'Implementation languages': '實現語言',
      'This sector does not have any description.': '此部門沒有任何描述。',
      ...
      'Creation date': '創建日期',
      'Created the': '已創建',
      'Creation date (in this platform)': '創建日期(在此平台中)',
      'Technical date': '技術日期',
      'Functional date': '功能日期',
      'Date reference': '日期引用',
      'Modification date': '修改日期',
      'Updated the': '已更新',
      'Update entities': '更新實體',
      Creator: '創建者',
      Creators: '創作者',
      Validate: '驗證',
      Marking: '標記',
      Markings: '標記',
      'Kill chain phases': '殺傷鏈階段',
      'Kill chain phase': '殺傷鏈階段',
      'Global kill chain': '全局殺傷鏈',
      Definition: '定義',
      Level: '級別',
      Color: '顏色',
      Abstract: '抽象',
      ...
      'Email address': '郵件地址',
      name: '姓名',
      'Threat actor types': '威脅主體類型',
      'Malware types': '惡意軟體類型',
      Revoked: '撤銷',
      'STIX Version': 'STIX版本',
      Firstname: '名字',
      Lastname: '姓氏',
      ...
      Start: '開始',
      Stop: '結束',
      'Verify SSL certificate': '驗證SSL證書',
      Confirmation: '確認',
      'Kill chain': '殺傷鏈',
      'This feature is not available yet.': '此功能尚不可用。',
      'This page is not found on this OpenCTI application.':
        '在此OpenCTI應用程序上找不到此頁面。',
      'Phase name': '階段名稱',
      'Kill chain name': '殺傷鏈名稱',
      'You have no subscription for the moment.': '您暫時沒有訂閲。',
      Renew: '更新',
      Order: '次序',
      Options: '選項',
      'Assignee(s)': '協調人',
      ...
      'Top 10 threats targeting this entity': '針對此實體的10大威脅',
      'Top 10 active entities (3 last months)': '10大活躍實體(最近3個月)',
      'Targeted countries (3 last months)': '針對的國家/地區(最近3個月)',
      Publication: '發佈',
      'Entity type': '實體類型',
      'Report type': '報告類型',
      'Report types': '報告類型',
      ...
      Pattern: '模式',
      'Pattern type': '模式類型',
      'Indicator pattern': '攻擊指標模式',
      'Valid from': '有效期從',
      'Valid until': '有效期至',
      Score: '分數',
      'Search for an entity': '搜尋實體',
      'Linked knowledge': '鏈接知識',
      'Linked entities': '鏈接實體',
      'Nested objects': '嵌套對象',
      'Links with threats': '鏈接威脅',
      ...
      'External ID': '外部ID',
      'Log sources': '日誌源',
      'Threat hunting techniques': '威脅狩獵技術',
      external: '外部',
      Relations: '關係',
      relations: '關係',
      URL: 'URL',
      ...
      'Incident type': '事件類型',
      'Incident Date': '事件日期',
      'Confidence level': '置信級別',
      Confidence: '置信度',
      'The min value cannot be greater than max value': '最小值不能大於最大值',
      'Each tick value must be between min and max value':
        '每個刻度值必須介於最小值和最大值之間',
      'The value must be between min and max value':
        '該值必須介於最小值和最大值之間',
      'The value must be greater than or equal to 0': '該值必須大於或等於 0',
      'The value must be less than or equal to 100': '該值必須小於或等於 100',
      'The color must be written in hexadecimal. Example: #ff9800':
        '顏色必須以十六進制書寫。示例：#ff9800',
      'confidence scale configuration has been successfully updated':
        '置信度配置已成功更新',
      'Add Tick': '添加標記',
      'Request for information type': '請求信息類型',
      'Request for takedown type': '請求刪除類型',
      'Response type': '響應類型',
      'Related cases': '相關案例',
      'Information type': '信息類型',
      'Takedown type': '下線類型',
      'Request For Information Date': '索取資料日期',
      'Request For Takedown Date': '請求刪除日期',
      Ticks: '標記',
      ...
      Sophistication: '複雜度',
      'Resource level': '資源級別',
      'Primary motivation': '主要動機',
      'Secondary motivations': '次要動機',
      'Personal motivations': '個人動機',
      Goals: '目標',
      'Goals (1 / line)': '目標(1/行)',
      'Log sources (1 / line)': '日誌源(1/行)',
      'Observable value': '可觀測值',
      'Observable type': '可觀測類型',
      'Observable types': '可觀測類型',
      'Indicator type': '攻擊指標類型',
      'Indicator types': '攻擊指標類型',
      'Main observable type': '主要可觀測類型',
      'Played role': '扮演的角色',
      'Observables roles': '可觀測角色',
      'Enable two-factor authentication': '啓用雙重身份驗證',
      ...
      'Windows services': 'Windows服務',
      'Windows scheduled tasks': 'Windows計劃任務',
      'X509 Certificates': 'X509證書',
      Registry: '註冊表',
      'Registry key': '註冊表鍵',
      'Registry key value': '註冊表鍵值',
      'File hash': '文件哈希',
      ...
      Key: '鍵',
      Value: '值',
      'Linked threat(s)': '鏈接威脅',
      'Linked threat': '鏈接威脅',
      // Statistics
      'No widget in this workspace': '此工作區沒有控件',
      'Averages of context relations': '上下文關係的平均值',
      'Synthesis of knowledge': '知識綜合',
      Statistics: '統計',
      Metrics: '指標',
      'Queued bundles': '排隊的捆綁包',
      'Total number of documents': '文檔總數',
      'Connected workers': '已連接的工作器',
      'No work': '沒有工作',
      'No task': '沒有任務',
      'In progress messages': '進行中的消息',
      'Bundles processed': '已處理的捆綁包',
      'Last processed message': '上次處理的消息',
      'Total processed messages': '已處理消息總數',
      'Read operations': '讀取操作',
      'Write operations': '寫入操作',
      Write: '寫入',
      Preview: '預覽',
      'Graph type': '圖表類型',
      'Table (top 10)': '表(前10個)',
      'Workers statistics': '工作器統計',
      'Pie chart': '餅圖',
      'Donut chart': '圓環圖',
      'Radar chart': '雷達圖',
      Table: '表',
      ...
      'TimeLine view': '時間線視圖',
      List: '列表',
      'List (distribution)': '列表（分佈）',
      'Vertical Bar': '豎條',
      'Horizontal Bar': '橫條',
      Donut: '甜甜圈',
      Map: '地圖',
      Heatmap: '熱圖',
      'Total pending inserts': '待處理插入總數',
      'Relations to threats': '與威脅的關係',
      'Relations to other entities': '與其它實體的關係',
      'Context relations': '上下文關係',
      'Direct relations creations': '直接關係創建',
      'Number of target relations': '目標關係數目',
      'Total entities': '實體總數',
      'Total relationships': '關係總數',
      Relationship: '關係',
      'Total observables': '可觀測數據總數',
      'Total reports': '報告總數',
      'Total workspaces': '工作區總數',
      'Total notes': '註釋總數',
      'Total relations': '關係總數',
      'Total indicators': '攻擊指標總數',
      'Total direct relations': '直接關係總數',
      'Top Labels (3 last months)': '最多標籤(最近3個月)',
      'Last ingested reports (creation date in the platform)':
        '上次攝取的報告（平台中的創建日期）',
      'Distribution of entities': '實體分佈',
      'Entities distribution': '實體分佈',
      'Distribution of opinions': '意見分佈',
      'Observables distribution': '可觀測數據分佈',
      'Distribution of relations (including inferred)': '關係分佈(包含推理)',
      'Distribution of relations': '關係分佈',
      'Distribution of sources': '源分佈',
      'Latest created relationships': '最新創建的關係',
      'Last targeted organizations in this sector':
        '在此部門中最近被針對的組織',
      'Ingested entities': '引入的實體',
      'Created entities': '創建的實體',
      '24 hours': '24小時',
      '30 days': '30天',
      'No entities were found for this search.': '未找到此搜尋的實體。',
      'No reports about this entity.': '沒有關於此實體的報告。',
      'API access': 'API訪問',
      Example: '示例',
      'API key': 'API密鑰',
      Playground: 'Playground',
      'Basic information': '基礎信息',
      Details: '詳情',
      'Entity details': '實體詳情',
      'Most recent history': '最近歷史操作',
      All: '所有',
      Clear: '清除',
      'Clear filters': '清除過濾器',
      'has updated the field': '已更新字段',
      'with the value': '與值',
      'has created the entity': '已創建實體',
      'has created a relation': '已創建關係',
      History: '歷史',
      'Files & history': '文件 & 歷史',
      'External references files': '外部引用文件',
      to: '到',
      'Relations of the entity': '實體關係',
      'No entities of this type has been found.': '未找到此類型的實體。',
      'No notes about this entity yet.': '尚無關於此實體的註釋',
      'Notes about this entity': '關於此實體的註釋',
      'Notes about this relationship': '關於此關係的註釋',
      'No history about this entity.': '關於此實體的歷史。',
      'No relations history about this entity.': '尚無關於此實體的關係歷史',
      'Already in plat.': '經在平台',
      // Explore
      'Kill chains': '殺傷鏈',
      'Explore the victims and the targets of the dataset through space and time.':
        '通過空間和時間探索數據集的受害者和目標。',
      'Explore the attack campaigns of the dataset through time and involved entities.':
        '通過時間和相關實體探索數據集的攻擊活動。',
      'Explore the techniques, tactics and procedures of the dataset through time and entities who used its.':
        '通過時間和使用數據集的實體探索數據集的TTPs（技術、戰術和程序）。',
      'Explore the kill chains of entities through time and other contextual information like campaigns or incidents.':
        '通過時間和其它上下文信息（如攻擊活動或安全事件）探索實體的殺傷鏈',
      'Explore the vulnerabilities used by entities through time and kill chain phases.':
        '通過時間和殺傷鏈探索實體使用的漏洞.',
      'Explore the observables of the dataset though time to visualize clusters and correlations.':
        '通過時間探索數據集的可觀測數據，以進行可視化聚類和關聯。',
      'Origins of the targeting': '針對的起源',
      'Types of the targeting': '針對的類型',
      'Types of the targets': '目標的類型',
      'Targeted entity types': '針對的實體類型',
      'Targeted entity through time': '隨時間推移的目標實體',
      'Number of targeting': '針對的數量',
      'Related entities (generic relation "related-to")':
        '相關實體(通用關係"related-to")',
      'This panel shows by default the latest created entities, use the search to find more.':
        '此面板默認顯示最新創建的實體，請使用搜尋查找更多信息。',
      'Remove from the container': '從容器中取出',
      'Do you want to delete this entity?': '是否要刪除此實體？',
      Platforms: '平台',
      Platform: '平台',
      'Affected software': '受影響的軟體',
      'Commit message': '提交消息',
      'Commit messages': '提交消息',
      'Reference knowledge update': '引用知識更新',
      'Reference modification': '引用修改',
      'Required permissions': '所需權限',
      'Enable commit messages': '啓用提交消息',
      'Commit message when updating data from the UI.':
        '從UI更新數據時提交消息',
      'To use this feature, your platform administrator must enable the subscription manager in the config.':
        '要使用此功能，平台管理員必須在配置中啓用訂閲管理器。',
      'To use this feature, your platform administrator must enable the according manager in the config.':
        '要使用此功能，您的平台管理員必須在配置中啟用相應的管理器。',
      'In OpenCTI, a predictable STIX ID is generated based on one or multiple attributes of the entity.':
        '在 OpenCTI 中，基於實體的一個或多個屬性生成可預測的 STIX ID。',
      Layers: '層',
      'Cloud Control Plane': '雲控制平面',
      Host: '主機',
      Network: '網絡',
      None: '無',
      Nonee: '無',
      Status: '狀態',
      'Analyst workbenches': '分析師工作區',
      'Create a workbench': '創建工作區',
      'Default value': '默認值',
      'Add and complete': '添加並完成',
      'Update and complete': '更新並完成',
      'Manage an entity': '管理實體',
      'Manage an observable': '管理一個可觀察的',
      'Manage a container': '理容器',
      'Do you want to remove this object?': '是否要刪除此對象？',
      'Add context': '添加上下文',
      'Organizations restriction': '組織限制',
      ...
      'Bulk search': '批量搜尋',
      'Search for multiple entities': '搜尋多個實體',
      'One keyword by line or separated by commas':
        '一個關鍵字逐行或以逗號分隔',
      'Share with an organization': '與組織共享',
      Share: '分享',
      'Open the suggestions': '打開建議',
      'Reset filters': '重置過濾器',
      reversed: '反轉',
      Limit: '限制',
      'All threats': '所有威脅',
      ...
      '24h': '24小時',
      // Types
      'All types of relationship': '關係的所有類型',
      'All types of entity': '所有類型的實體',
      entity_All: '所有實體',
      'entity_Stix-Domain-Object': 'STIX域對象',
      'entity_Stix-Domain-Objects': 'STIX域對象',
      'entity_Stix-Core-Objects': 'STIX核心對象',
      'entity_Stix-Core-Relationship': 'STIX核心關係',
      'entity_stix-core-relationship': 'STIX核心關係',
      'entity_stix-sighting-relationship': 'STIX目擊關係',
      entity_Identity: '身份',
      entity_Location: '地點',
      entity_Relationship: '關係',
      'entity_Marking-Definition': '標記定義',
      'entity_External-Reference': '外部引用',
      entity_Label: '標籤',
      'entity_Attack-Pattern': '攻擊模式',
      entity_Campaign: '攻擊活動',
      entity_Note: '註釋',
      'entity_Observed-Data': '可觀測數據',
      entity_Opinion: '意見',
      entity_Analysis: '分析',
      entity_Events: '事件',
      entity_Sighting: '目擊',
      ...
      entity_Report: '分組',
      entity_Grouping: '分組',
      'entity_Course-Of-Action': '應對措施',
      'entity_Data-Component': '數據元件',
      'entity_Data-Source': '數據源',
      entity_Individual: '個體',
      entity_Organization: '組織',
      entity_Sector: '部門',
      entity_System: '系統',
      entity_Event: '事件',
      entity_Indicator: '攻擊指標',
      entity_Infrastructure: '基礎設施',
      'entity_Intrusion-Set': '入侵集合',
      entity_City: '城市',
      'entity_Administrative-Area': '領域',
      entity_Country: '國家/地區',
      entity_Region: '區域',
      entity_Position: '位置',
      entity_Malware: '惡意軟體',
      'entity_Threat-Actor': '威脅源',
      entity_Tool: '攻擊工具',
      entity_Channel: '渠道',
      entity_Narrative: '敍述',
      entity_Language: '語',
      entity_Vulnerability: '漏洞',
      entity_Incident: '安全事件',
      'entity_Stix-Cyber-Observable': 'STIX網絡可觀測數據',
      'entity_Stix-Cyber-Observables': 'STIX網絡可觀測數據',
      'entity_Autonomous-System': '自治系統',
      entity_Directory: '目錄',
      'entity_Domain-Name': '域名',
      'entity_Email-Addr': '電子郵件地址',
      'entity_Email-Message': '電子郵件消息',
      'entity_Email-Mime-Part-Type': '電子郵件擴充部分類型',
      entity_Artifact: '工件',
      entity_StixFile: 'STIX文件',
      entity_Stixfile: 'STIX文件',
      'entity_X509-Certificate': 'X509證書',
      ...
      entity_Mutex: '互斥體',
      'entity_Network-Traffic': '網絡流量',
      entity_Process: '處理程序',
      entity_Software: '軟體',
      entity_Url: 'URL',
      'entity_User-Account': '用戶帳戶',
      'entity_Windows-Registry-Key': 'Windows註冊表鍵',
      'entity_Windows-Registry-Value-Type': 'Windows註冊表值類型',
      'entity_Cryptographic-Key': '加密密鑰',
      'entity_Cryptocurrency-Wallet': '加密貨幣錢包',
      entity_Hostname: '主機名',
      entity_Text: '文本',
      'entity_User-Agent': '用戶代理',
      'entity_Bank-Account': '銀行帳戶',
      'entity_Phone-Number': '電話號碼',
      'entity_Payment-Card': '支付卡',
      'entity_Media-Content': '媒體內容',
      // Relations
      relationship_All: '所有關係',
      'relationship_service-dll': '服務DLL',
      relationship_image: '圖片',
      relationship_object: '對象',
      'relationship_x_opencti_linked-to': '鏈接到 (ref)',
      relationship_to: '到',
      relationship_from: '從',
      relationship_cc: 'cc',
      relationship_bcc: 'bcc',
      relationship_src: 'src',
      relationship_dst: 'dst',
      relationship_sender: '發件人',
      relationship_obs_content: '內容 (ref)',
      'relationship_resolves-to': '解析為',
      'relationship_obs_resolves-to': '解析為 (ref)',
      'relationship_belongs-to': '屬於',
      'relationship_obs_belongs-to': '屬於 (ref)',
      'relationship_cooperates-with': '與合作',
      'relationship_participates-in': '參與',
      relationship_contains: '包含',
      relationship_values: '價值觀',
      'relationship_stix-sighting-relationship': '目擊關係',
      'relationship_external-reference': '外部引用',
      'relationship_created-by': '被創建',
      'relationship_kill-chain-phase': '殺傷鏈階段',
      'relationship_object-marking': '目標標記',
      'relationship_object-label': '目標標籤',
      'relationship_revoked-by': '撤銷',
      relationship_delivers: '投遞',
      relationship_targets: '針對',
      'relationship_granted-to': '授予',
      relationship_uses: '使用',
      relationship_publishes: '發表',
      relationship_amplifies: '放大',
      'relationship_attributed-to': '歸因於',
      relationship_compromises: '失陷',
      'relationship_originates-from': '起源於',
      relationship_investigates: '調查',
      relationship_mitigates: '緩解',
      'relationship_located-at': '位於',
      relationship_indicates: '指示',
      'relationship_based-on': '基於',
      'relationship_communicates-with': '通信',
      'relationship_consists-of': '包含',
      relationship_controls: '控制',
      'relationship_relation-has': '關係有',
      relationship_hosts: '託管',
      relationship_owns: '擁有',
      'relationship_authored-by': '作者',
      'relationship_beacons-to': '指引到',
      'relationship_exfiltrates-to': '滲透到',
      relationship_downloads: '下載',
      relationship_drops: '丟棄',
      relationship_exploits: '利用',
      'relationship_variant-of': '變種',
      relationship_characterizes: '特徵',
      'relationship_analysis-of': '分析',
      'relationship_static-analysis-of': '靜態分析',
      'relationship_dynamic-analysis-of': '動態分析',
      relationship_impersonates: '冒充',
      relationship_remediates: '補救',
      'relationship_related-to': '關聯到',
      'relationship_derived-from': '源自',
      'relationship_duplicate-of': '副本',
      'relationship_part-of': '部分',
      'relationship_subtechnique-of': '子技術',
      'relationship_subnarrative-of': '的子敍事',
      relationship_has: '有',
      relationship_sample: '樣本',
      'relationship_body-multipart': 'body multipart',
      'relationship_body-raw': 'body raw',
      relationship_child: 'child',
      'relationship_creator-user': 'creator',
      ...
      reliability_C: 'C - 相當可靠',
      reliability_D: 'D - 通常不可靠',
      reliability_E: 'E - 不可靠',
      reliability_F: 'F - 可靠性無法判斷',
      reliability_null: '空',
      sophistication_none: '無',
      sophistication_minimal: '最小',
      sophistication_intermediate: '中檔',
      sophistication_advanced: '先進',
      sophistication_expert: '專家',
      sophistication_innovator: '創新者',
      sophistication_strategic: '戰略',
      sophistication_unkown: '未知',
      individual: '個體',
      club: '俱樂部',
      contest: '比賽',
      ...
      ideology: '意識形態',
      notoriety: '名氣',
      'organizational-gain': '組織收益',
      'personal-gain': '個人收益',
      'personal-satisfaction': '個人滿足感',
      revenge: '報復',
      unpredictable: '無法預知',
      unknown: '未知',
      organization_constituent: '選民',
      organization_csirt: 'CSIRT',
      organization_partner: '合作伙伴',
      organization_vendor: '供應商',
      organization_other: '其他',
      obsContent: '內容',
      'Use Alt + click to exclude items': '使用 Alt + 按兩下排除專案',
      filter_container_type: '分析類型 (Type of analysis)',
      filter_basedOn: '基於可觀察對象 (Based on an observable)',
      filter_sightedBy: '目擊訊息 (Sighted by/in)',
      filter_sightedBy_not_eq: '未被目擊訊息 (NOT Sighted by/in)',
      filter_entity_type: '實體類型 (Entity type)',
      filter_entity_type_not_eq: '非實體類型 (NOT Entity type)',
      filter_relationship_type: '關係類型 (Relationship type)',
      filter_relationship_type_not_eq: '非關係類型 (NOT Relationship type)',
      filter_indicator_types: '指標類型 (Indicator type)',
      filter_indicator_types_not_eq: '非指標類型 (NOT Indicator type)',
      filter_pattern_type: '模式類型 (Pattern type)',
      filter_pattern_type_not_eq: '非模式類型 (NOT Pattern type)',
      filter_incident_type: '事件類型 (Incident type)',
      filter_incident_type_not_eq: '非事件類型 (NOT Incident type)',
      filter_x_opencti_main_observable_type: '可觀察對象類型 (Observable type)',
      filter_labelledBy: '標籤 (Label)',
      filter_labelledBy_not_eq: '無此標籤 (NOT Label)',
      filter_createdBy: '作者 (Author)',
      filter_createdBy_not_eq: '非作者 (NOT Author)',
      filter_category: '類別 (Category)',
      filter_entity_types: '實體類型 (Entity types)',
      filter_creator: '技術創建者 (Technical creator)',
      filter_creator_not_eq: '非技術創建者 (NOT Technical creator)',
      filter_markedBy: '標記定義 (Marking definition)',
      filter_markedBy_not_eq: '無標記定義 (NOT Marking definition)',
      filter_objectContains: '包含 (Contains)',
      filter_confidence: '信心 (Confidence)',
      filter_confidence_gt: '信心大於 (Confidence greater than)',
      filter_confidence_lte: '信心小於或等於 (Confidence less than or equal)',
      filter_x_opencti_workflow_id: '狀態 (Status)',
      filter_x_opencti_workflow_id_not_eq: '非狀態 (NOT Status)',
      filter_report_types: '報告類型 (Report type)',
      filter_report_types_not_eq: '非報告類型 (NOT Report type)',
      filter_channel_types: '通道類型 (Channel type)',
      filter_channel_types_not_eq: '非通道類型 (NOT Channel type)',
      filter_event_types: '事件類型 (Event type)',
      filter_event_types_not_eq: '非事件類型 (NOT Event type)',
      filter_context: '上下文 (Context)',
      filter_context_not_eq: '非上下文 (NOT Context)',
      filter_published_start_date: '開始發佈日期 (Published start date)',
      filter_published_end_date: '結束發佈日期 (Published end date)',
      filter_created_start_date: '開始創建日期 (Created after)',
      filter_created_end_date: '結束創建日期 (Created before)',
      filter_created_at_start_date: '開始匯入日期 (Ingested after)',
      filter_created_at_end_date: '結束匯入日期 (Ingested before)',
      filter_likelihood: '可能性 (Probability)',
      filter_likelihood_gt: '可能性大於 (Probability greater than)',
      filter_likelihood_lte: '可能性小於或等於 (Probability less than or equal)',
      filter_note_types: '筆記類型 (Note type)',
      filter_note_types_not_eq: '非筆記類型 (NOT Note type)',
      filter_modified_start_date: '開始修改日期 (Modified after)',
      filter_modified_end_date: '結束修改日期 (Modified before)',
      filter_valid_from_start_date: '有效期限開始日 (Valid from)',
      filter_valid_until_end_date: '有效期限結束日 (Valid until)',
      filter_x_opencti_score: '分數 (Score)',
      filter_x_opencti_negative: '合格 (Qualification)',
      filter_x_opencti_negative_not_eq: '不合格 (NOT Qualification)',
      filter_x_opencti_score_gt: '分數大於 (Score greater than)',
      filter_x_opencti_score_lte: '分數小於或等於 (Score less than or equal)',
      filter_x_opencti_detection: '檢測 (Detection)',
      filter_x_opencti_base_score: 'CVSS3 分數 (CVSS3-Score)',
      filter_x_opencti_base_score_gt: 'CVSS3 分數大於 (CVSS3-Score greater than)',
      filter_x_opencti_base_score_lte: 'CVSS3 分數小於或等於 (CVSS3-Score less than or equal)',
      filter_x_opencti_base_severity: 'CVSS3 嚴重性 (CVSS3-Severity)',
      filter_x_opencti_attack_vector: 'CVSS3 攻擊向量 (CVSS3-Attack vector)',
      filter_toCreatedAt_start_date: '開始匯入日期 (Ingested after)',
      filter_toCreatedAt_end_date: '結束匯入日期 (Ingested before)',
      filter_x_opencti_organization_type: '組織類型 (Organization type)',
      filter_indicates: '指示 (Indicates)',
      filter_revoked: '撤銷 (Revoked)',
      filter_toSightingId: '目擊訊息 (Sighted in/at)',
      filter_fromId: '來源實體 (Source entity)',
      filter_toId: '目標實體 (Target entity)',
      filter_fromTypes: '來源類型 (Source type)',
      filter_toTypes: '目標類型 (Target type)',
      filter_elementId: '相關實體 (Related entity)',
      filter_killChainPhase: '殺傷鏈階段 (Kill Chain phase)',
      filter_malware_types: '惡意軟體類型 (Malware types)',
      filter_malware_types_not_eq: '非惡意軟體類型 (NOT Malware types)',
      filter_targets: '目標實體 (Target entity)',
      filter_assigneeTo: '分配給 (Assignee)',
      filter_priority: '優先度 (Priority)',
      filter_severity: '嚴重性 (Severity)',
      filter_is_read: '已讀? (Is read?)',
      filter_start_time_end_date: '開始日期之前 (Start date before)',
      filter_start_time_start_date: '開始日期之後 (Start date after)',
      filter_stop_time_end_date: '結束日期之前 (End date before)',
      filter_stop_time_start_date: '結束日期之後 (End date after)',
      filter_source: '來源 (Source)',
      Creator_id: '造物主',
      'Created-by.internal_id': '作者',
      'Object-assignee.internal_id': '受讓人',
      'Object-marking.internal_id': '標記定義',
      'Kill-chain-phase.internal_id': '殺傷鏈階段',
      Entity_type: '類型',
      EXTERNAL_IMPORT: '外部匯入',
      INTERNAL_IMPORT_FILE: '匯入文件',
      INTERNAL_EXPORT_FILE: '匯出文件',
      ...
      'Max retention': '最長保留期',
      'Maximum retention days': '最長保留天數',
      'Last execution': '上次執行時間',
      'Create a retention policy': '創建保留策略',
      ...
      false: '假',
      GRAPHQL_API: 'API GraphQL',
      EXPIRATION_SCHEDULER: '過期計劃程序',
      TASK_MANAGER: '任務管理器',
      RULE_ENGINE: '規則引擎',
      SYNC_MANAGER: '同步管理器',
      SUBSCRIPTION_MANAGER: '訂閲管理器',
      RETENTION_MANAGER: '保留管理器',
      PUBLISHER_MANAGER: '通知發布經理',
      NOTIFICATION_MANAGER: '通知生成管理器',
      HISTORY_MANAGER: '歷史經理',
      'Workflow of': '的工作流程',
      'Create a status': '創建狀態',
      'Update a status': '更新狀態',
      ...
      'Observables and indicators conversion': '可觀測數據和指標轉換',
      'This action will generate observables from the selected indicators.':
        '此操作將從選定的指標生成 observables。',
      'This action will generate STIX patterns indicators from the selected observables.':
        '此操作將從選定的 observables 生成 STIX 模式指標。',
      'Indicators/observables generation': '指標/可觀察的生成',
      'Create an opinion': '創建意見',
      'Update opinion': '更新意見',
      disagree: '不同意',
      neutral: '中性的',
      agree: '同意',
      'Automatic references at file upload': '文件上傳時自動引用',
      'suggestion_threats-indicators':
        '在指標和所選威脅之間創建“指示”關係，然後將所有關係添加到容器中',
      Collapse: '摺疊',
      // Egoist補充
      'Incident response': '事件反應',
      'Requests for information': '資訊請求',
      'Requests for takedown': '下架請求',
      'Feedbacks': '回饋意見',
      'Investigations': '調查 (Investigations)',
      'Data import and analyst workbenches': '數據匯入與分析工作室 (Data import and analyst workbenches)',
      'Notifications and triggers': '通知與觸發器 (Notifications and triggers)',
      'Positions': '位置',
      'Ingestion': '數據摘取',
      Duplicate: '複製',
      'Do you want to duplicate this widget?': '確定要複製這個 widget 嗎？',
      'Do you want to export this workspace?': '是否要匯出此工作區？',
    },
    'en-us': {
      gt: 'Greater than',
